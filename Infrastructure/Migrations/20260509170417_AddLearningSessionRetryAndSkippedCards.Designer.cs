...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20260509170417_AddLearningSessionRetryAndSkippedCards")]
    partial class AddLearningSessionRetryAndSkippedCards
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.ConversationSession", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
                    ...
                    b.Property<string>("CustomScenario")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)");
                    ...
                    b.Property<string>("ResultModel")
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)");

                    b.Property<string>("ResultPromptVersion")
                        .HasMaxLength(100)
                    ...
                    b.Property<int>("UserMessagesCount")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(0);
            ...
            modelBuilder.Entity("Domain.Entities.ExamSessionAiAnalysis", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
                    ...
                    b.HasIndex("ExamSessionId", "PromptVersion", "InputHash")
                        .HasDatabaseName("idx_exam_session_ai_analyses_session_prompt_hash");

                    b.HasIndex("UserId", "TriggerType", "CreatedAt")
                        .HasDatabaseName("idx_exam_session_ai_analyses_user_trigger_created");

                    b.ToTable("exam_session_ai_analyses", (string)null);
                });

            modelBuilder.Entity("Domain.Entities.ExtractedVocabulary", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
                    ...
                    b.ToTable("extracted_vocabularies", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Entities.StudySession", b =>
                {
                    ...
                    b.Property<List<string>>("RetryCardIds")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasColumnType("text[]")
                        .HasDefaultValueSql("'{}'::text[]");
                    ...
                    b.Property<List<string>>("SkippedCardIds")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasColumnType("text[]")
                        .HasDefaultValueSql("'{}'::text[]");
            ...
            modelBuilder.Entity("Domain.Entities.ConversationMessage", b =>
                {
                    b.HasOne("Domain.Entities.ConversationSession", "Conversation")
                        .WithMany("Messages")
            ...
            modelBuilder.Entity("Domain.Entities.ExamSessionAiAnalysis", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.User", "User")
                        .WithMany("ExamSessionAiAnalyses")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("Domain.Entities.ExtractedVocabulary", b =>
                {
                    b.HasOne("Domain.Entities.ConversationMessage", "Message")
                        .WithMany("NewVocabulary")
            ...
            modelBuilder.Entity("Domain.Entities.User", b =>
                {
                    ...
                    b.Navigation("ExamSessionAiAnalyses");
